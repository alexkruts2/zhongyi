    ...
    <div class="row page-titles">
        ...
        <div class="col-md-6">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">查看问答</li>
            </ol>
        </div>
        <div class="col-md-6 text-right">
            <button type="button" class="btn btn-info" onclick="location.href='/doctor/qa/create';">添加</button>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tbl_qa" class="display nowrap table table-striped table-bordered">
                            <thead>
                            <tr>
