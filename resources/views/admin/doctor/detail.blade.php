                ...
                <div class="card-body">
                    <form id="doctor-form" novalidate method="post">
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="text" disabled value="{{$doctor[0]->name}}" name='name' id="name" placeholder="姓名">
                            </div>
                        </div>
                        <div class="form-group mt-3 row">
                            <label for="example-text-input" class="col-2 col-form-label text-right">手机号</label>
                            <div class="col-10">
                                <input class="form-control" type="text" disabled  value="{{$doctor[0]->phone}}" name='phone' id="phone" placeholder="手机号">
                            </div>
                        </div>
                        <div class="form-group mt-3 row">
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="col-10">
                                <textarea class="form-control" disabled type="text" value="{{$doctor[0]->introduction}}" name='introduction' id="introduction" placeholder="按摩，抓药">{{$doctor[0]->introduction}}</textarea>
                            </div>
                        </div>
                        <div class="form-group mt-3 row">
                            <label class="col-2 col-form-label text-right">从</label>
                            <div class="input-group clockpicker col-10">
                                <input type="text" class="form-control" value="{{$doctor[0]->from}}" disabled  name='from' id="from">
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="input-group clockpicker col-10">
                                <input type="text" class="form-control" value="{{$doctor[0]->to}}" name='to' disabled  id="to">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="fa fa-clock-o"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="text" value="{{$doctor[0]->visiting_place}}" disabled  name='visiting_place' id="visiting_place" placeholder="出诊地点"/>
                            </div>
                        </div>
                    </form>
                </div>
