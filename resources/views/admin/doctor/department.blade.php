...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-12">
            <h4 class="text-white">医院分科</h4>
        </div>
        <div class="col-md-6">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin">首页</a></li>
                <li class="breadcrumb-item active">医院分科</li>
            </ol>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tbl_department" class="display nowrap table table-striped table-bordered">
                            <thead>
                            <tr>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-2 text-right" style="line-height: 38px;">新科室</div>
                        <div class="col-10">
                            <input class="form-control" id="department_name" name="department_name" type="text" required="" placeholder="请输入科室名">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" onclick="createDepartment()"><i class="ti-save"></i> 保存</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="editModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" id="saveBtn" data-id="0" onclick="saveDepartment(this)"><i class="ti-save"></i> 保存</button>
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('static/admin/department.js') }}"></script>
