            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <select class="selectpicker form-control" data-style="btn-info" id="city" disabled>
                                <option value="-1">--请选择城市--</option>
                            </select>
                        </div>
                        <div class="col-md-3">
{{--                            <button class="btn btn-success" onclick="searchSuburb()"><i class="ti-search"></i></button>--}}
                            <button class="btn btn-primary" onclick="showModal(true, 0, null)"><i class="ti-plus"></i></button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div id="suburb-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">小区信息</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <form id="suburb-form" novalidate>
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="selectpicker form-control" data-style="btn-info" id="state_id" name="state_id" onchange="changeState()">
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <select class="selectpicker form-control" data-style="btn-info" id="city_id" name="city_id">
                                </select>
                            </div>
                            <div class="form-group row">
                                <div class="col-6">
                            ...
                            <div class="form-group">
                                <h5>邮编 : <span class="text-danger">*</span> </h5>
                                <div class="controls">
                                    <input type="text" class="form-control" id="post_code" name="post_code" required data-validation-required-message="必填" value="" placeholder="请输入邮编...">
                                </div>
                            </div>
                            <input id="suburb_id" name="suburb_id" type="hidden" value="">
                        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('static/admin/suburb.js') }}"></script>
