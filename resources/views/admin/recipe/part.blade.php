        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-2 text-right" style="line-height: 38px;">新分类</div>
                        <div class="col-10">
                            <input class="form-control" id="part_name" name="part_name" type="text" required="" placeholder="请输入分类">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" onclick="createRecipe_part()"><i class="ti-save"></i> 保存</button>
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('static/admin/recipe_part.js') }}"></script>
