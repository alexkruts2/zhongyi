...
Route::group(['prefix' => 'doctor'], function () {
    Route::group(['middleware' => 'admin'], function() {
        Route::group(['prefix' => 'accept'], function () {
            ...
            Route::post('/payment/create','Admin\AcceptController@getNewPaymentData')->name('accept.payment.create.view');
        ...
        Route::group(['prefix' => 'recipe'], function () {
            ...
            Route::post('/give','Admin\HomeController@getMedicineData')->name('doctor.recipe.give');
        ...
        Route::group(['prefix' => 'inquiry'], function () {
            ...
            Route::post('/updateRecipe', 'Admin\DoctorController@updateRecipe')->name('doctor.inquiry.updateRecipe');
            Route::get('/startTreatment', 'Admin\DoctorController@startTreatment')->name('doctor.inquiry.startTreatment');
            Route::get('/editView', 'Admin\DoctorController@editInquiryView')->name('doctor.inquiry.editInquiryView');
            Route::post('/getList', 'Admin\DoctorController@getInquiryList')->name('doctor.inquiry.getInquiryList');
            Route::get('/edit/{id}', 'Admin\DoctorController@editInquiry')->name('doctor.inquiry.editInquiry');
